    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-4 ">
                <a href='http://assforum.org' onclick='function go(ev) { ev.preventDefault(); var win = window.open("http://assforum.org", "_blank"); win.focus(); }; go(event);'>
            ...
            <div class="col-xs-12 col-sm-4 text-right">
                <a  title='<?php eT("Visit our website!"); ?>' href='http://assforum.org' target='_blank'>AssFSURVEY</a><br />
